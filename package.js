Package.describe({
  summary: 'Accounts Templates styled for uikit.',
  version: '1.13.1',
  name: 'cyloncourt:useraccounts-uikit',
  git: 'git@github.com:CylonCourt/useraccounts-uikit.git',
...
Package.on_use(function(api) {
  ...
  api.use('useraccounts:flow-routing@1.13.1', ['client', 'server'], {
    weak: true,
  });
  api.use('useraccounts:iron-routing@1.13.1', ['client', 'server'], {
    weak: true,
  });
